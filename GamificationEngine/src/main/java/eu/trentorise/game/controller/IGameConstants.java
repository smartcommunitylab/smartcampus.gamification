...
public interface IGameConstants {
    ...
    /*views and services - services - internalActions*/
    public static final String SERVICE_INTERNALACTIONS_PATH_RELATIVE = "/internalactions";
    public static final String SERVICE_INTERNALACTIONS_PATH = SERVICE_PATH + SERVICE_INTERNALACTIONS_PATH_RELATIVE;
    public static final String SERVICE_INTERNALACTIONS_SINGLE_PATH_PARAM = "intActId";
    public static final String SERVICE_INTERNALACTIONS_SINGLE_PATH_RELATIVE = SERVICE_INTERNALACTIONS_PATH_RELATIVE + "/{" + SERVICE_INTERNALACTIONS_SINGLE_PATH_PARAM + "}";
    public static final String SERVICE_INTERNALACTIONS_SINGLE_PATH = SERVICE_PATH + SERVICE_INTERNALACTIONS_SINGLE_PATH_RELATIVE;
    /*views and services - services - internalActions - params*/
    public static final String SERVICE_INTERNALACTIONS_PARAMS_PATH = SERVICE_INTERNALACTIONS_SINGLE_PATH + "/params";
