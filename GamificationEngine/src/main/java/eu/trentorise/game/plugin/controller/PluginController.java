...
public class PluginController extends AbstractCrudRestController<Plugin, Object, Plugin> {
    ...
    public @ResponseBody PluginResponse readPluginById(@PathVariable(value = IGameConstants.SERVICE_PLUGINS_SINGLE_PATH_PARAM) Integer plugId) {
        ...
        Plugin result = super.readResourceById(element);
    ...
    @Override
    protected Map<String, Object> populateUriVariables(Plugin containerWithIds, 
                                                       Plugin result, Map<String, Object> uriVariables) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    
    
    @Qualifier("pluginManager")
    @Autowired
    public void setManager(IRestCrudManager<Plugin, Object, Plugin> manager) {
        this.manager = manager;
    }

    @Qualifier("restCrudHelper")
    @Autowired
    public void setRestCrudHelper(RestCrudHelper<Plugin, Object, Plugin> restCrudHelper) {
