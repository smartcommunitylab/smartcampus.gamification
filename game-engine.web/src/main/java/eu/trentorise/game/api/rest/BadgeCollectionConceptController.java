...
public class BadgeCollectionConceptController {
	...
	@RequestMapping(method = RequestMethod.PUT, value = "/model/game/{gameId}/badges/{collectionId}")
	...
	@RequestMapping(method = RequestMethod.GET, value = "/model/game/{gameId}/badges/{collectionId}")
	public BadgeCollectionConcept readBadgeCollection(
		...
		throw new ResourceNotFoundException(String.format(
				"BadgeCollectionId %s not exist in game %s", collectionId,
				gameId));
	}
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/model/game/{gameId}/badges/{collectionId}")
	public void deleteBadgeCollection(@PathVariable String gameId,
		...
		try {
			...
			throw new IllegalArgumentException(
					"collectionId is not UTF-8 encoded");
		}
