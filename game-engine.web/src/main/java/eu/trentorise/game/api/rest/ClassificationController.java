...
public class ClassificationController {
    ...
    @RequestMapping(method = RequestMethod.POST,
            value = "/model/game/{domain}/{gameId}/classification", consumes = {"application/json"},
    ...
    @RequestMapping(method = RequestMethod.PUT,
            value = "/model/game/{domain}/{gameId}/classification/{classificationId}",
    ...
    @RequestMapping(method = RequestMethod.GET,
            value = "/model/game/{domain}/{gameId}/classification", produces = {"application/json"})
    ...
    @RequestMapping(method = RequestMethod.DELETE,
            value = "/model/game/{domain}/{gameId}/task/{classificationId}",
            produces = {"application/json"})
     ...
     */
    @RequestMapping(method = RequestMethod.POST,
            value = "/model/game/{domain}/{gameId}/incclassification",
            consumes = {"application/json"}, produces = {"application/json"})
    ...
    @RequestMapping(method = RequestMethod.PUT,
            value = "/model/game/{domain}/{gameId}/incclassification/{classificationId}",
            consumes = {"application/json"}, produces = {"application/json"})
    @ApiOperation(value = "Edit general classification definition")
     ...
     */
    @RequestMapping(method = RequestMethod.GET,
            value = "/data/game/{domain}/{gameId}/incclassification/{classificationId}",
            produces = {"application/json"})
     ...
     */
    @RequestMapping(method = RequestMethod.GET,
            value = "/data/game/{domain}/{gameId}/classification/{classificationId}",
            produces = {"application/json"})
