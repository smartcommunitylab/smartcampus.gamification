...
public class PointConceptController {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/model/game/{domain}/{gameId}/point",
    ...
    @RequestMapping(method = RequestMethod.PUT,
            value = "/model/game/{domain}/{gameId}/point/{pointId}",
            consumes = {"application/json"}, produces = {"application/json"})
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/model/game/{domain}/{gameId}/point",
