...
public class DomainChallengeController {
	...
	private static final Logger logger = LoggerFactory.getLogger(DomainChallengeController.class);
	...
	public ChallengeConcept deleteChallenge(@PathVariable String domain, @PathVariable String gameId,
