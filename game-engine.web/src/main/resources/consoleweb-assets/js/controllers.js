...
app.controller('HomeCtrl', function ($scope, $rootScope, $window, $uibModal, gamesFactory, utilsFactory) {
...
app.controller('GameCtrl', function ($scope, $rootScope, $window, $stateParams, $uibModal, gamesFactory, utilsFactory, $state) {
...
app.controller('ActionsCtrl', function ($scope, $rootScope, $stateParams, $uibModal, gamesFactory) {
...
// rules.html
app.controller('RulesCtrl', function ($scope, $rootScope, $stateParams, $uibModal, gamesFactory) {
...
// tasks.html
app.controller('TasksCtrl', function ($scope, $rootScope, $stateParams, $uibModal, gamesFactory) {
...
app.controller('MonitorCtrl', function ($scope, $rootScope, $stateParams, $uibModal, gamesFactory, $state) {
    $rootScope.currentGameId = $stateParams.id;
    $scope.currentPage = 1;
    $scope.items4Page = 10;
