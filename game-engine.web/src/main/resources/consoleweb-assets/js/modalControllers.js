...
// Edit game modal
app.controller('EditGameModalInstanceCtrl', function ($scope, $uibModalInstance, game, gamesFactory) {
    $scope.newGame = {};
...
// Delete game modal
app.controller('DeleteGameConfirmModalInstanceCtrl', function ($scope, $uibModalInstance, $window, game, gamesFactory) {
...
app.controller('DeleteInstanceConfirmModalInstanceCtrl', function ($scope, $uibModalInstance, $window, game, instance, instanceType, gamesFactory) {
...
app.controller('EditPointsInstanceModalInstanceCtrl', function ($scope, $uibModalInstance, game, instance, gamesFactory) {
    $scope.points = {};
...
app.controller('EditBadgesCollectionInstanceModalInstanceCtrl', function ($scope, $uibModalInstance, game, instance, gamesFactory) {
...
app.controller('EditActionModalInstanceCtrl', function ($scope, $uibModalInstance, gamesFactory, game, action) {
    $scope.input = {};
    $scope.ok = function () {
...
app.controller('DeleteConceptConfirmModalInstanceCtrl', function ($scope, $uibModalInstance, instance, game, type, gamesFactory) {
    $scope.argument = instance.name;
...
// Delete action modal
app.controller('DeleteActionConfirmModalInstanceCtrl', function ($scope, $uibModalInstance, argument, game, gamesFactory) {
...
app.controller('EditRuleModalInstanceCtrl', function ($scope, $uibModalInstance, gamesFactory, game, rule) {
    $scope.input = {};
    $scope.alerts = {};
...
app.controller('DeleteRuleModalInstanceCtrl', function ($scope, $uibModalInstance, gamesFactory, game, rule) {
    $scope.alerts = {
        'deleteError': '',
    };
...
app.controller('EditTaskModalInstanceCtrl', function ($scope, $uibModalInstance, gamesFactory, game, task) {
    $scope.alerts = {
        'taskErr': '',
    };
...
app.controller('DeleteTaskModalInstanceCtrl', function ($scope, $uibModalInstance, task, game, gamesFactory) {
