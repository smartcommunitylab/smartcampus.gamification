...
public class RestAPITest {
    ...
    public void createPlayer() {
        ...
        try {
            RequestBuilder builder =
                    MockMvcRequestBuilders.post("/console/game/" + GAME + "/player")
            ...
            builder = MockMvcRequestBuilders
                    .delete("/console/game/" + GAME + "/player/" + play.getPlayerId());
    ...
    public void updatePlayer() {
        ...
        try {
            RequestBuilder builder = MockMvcRequestBuilders
                    .put("/console/game/" + GAME + "/player/" + player.getPlayerId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    public void teamAPI() {
        ...
        try {
            RequestBuilder builder = MockMvcRequestBuilders.post("/console/game/" + GAME + "/team")
            ...
            builder = MockMvcRequestBuilders
                    .post("/console/game/" + GAME + "/team/" + team.getPlayerId() + "/members")
            ...
            builder = MockMvcRequestBuilders
                    .delete("/console/game/" + GAME + "/team/" + team.getPlayerId());
    ...
    public void readAPI() {
        ...
        RequestBuilder builder;
        try {
            builder = MockMvcRequestBuilders.get("/gengine/state/" + GAME + "/" + p.getPlayerId());
            mocker.perform(builder).andDo(MockMvcResultHandlers.print())
                    .andExpect(MockMvcResultMatchers.status().is(200))
