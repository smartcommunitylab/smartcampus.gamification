...
public class BadgeNotification extends Notification {
	...
	public BadgeNotification(String gameId, String playerId, String collectionName, String badge) {
		super(gameId, playerId);
		this.badge = badge;
	...
	public String toString() {
		return String.format("[gameId=%s, playerId=%s, collectionName=%s, badge=%s]", getGameId(), getPlayerId(),
