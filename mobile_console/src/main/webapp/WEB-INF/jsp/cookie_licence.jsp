	  				...
	  				<div class="panel-body">
						<div style="margin: 10px 10px 10px 10px">
							...
							<div class="well">
								...
								<div align="justify">
									Fatta eccezione per i cookie tecnici strettamente necessari alla normale navigazione, il conferimento dei dati è rimesso alla volontà dell'interessato 
									...
									l'installazione di cookie (così per la condivisione dei contenuti sui Social Network).
								</div>
								<div align="justify" style="margin-top: 10px;">
								...
								<div align="justify">
									Fermo restando quanto sopra indicato in ordine ai cookie strettamente necessari alla navigazione, l'utente può eliminare gli altri cookie attraverso la 
									funzionalità a tal fine messa a disposizione dal Titolare tramite la presente informativa oppure direttamente tramite il proprio browser.  <br/>
									<br/>
									...
									La disattivazione dei cookie di terze parti è inoltre possibile attraverso le modalità rese disponibili direttamente dalla società terza, come indicato ai link 
								...
								<div align="justify">
									...
									<ol type="a">
										...
										<li>dei soggetti o delle categorie di soggetti ai quali i dati personali possono essere comunicati o che possono venirne a conoscenza in qualità di rappresentante designato nel territorio dello Stato, 
									...
									<ol type="a">
										...
										<li> la cancellazione, la trasformazione in forma anonima o il blocco dei dati trattati in violazione di legge, compresi quelli di cui non è necessaria la conservazione in relazione agli scopi per i quali 
